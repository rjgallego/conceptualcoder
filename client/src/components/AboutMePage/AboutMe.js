                ...
                <div id="body-div">
                    ...
                    <div id="text-div">
                        ...
                        <p id="body-text">
                            ...
                            difficult and devestating for people around the work, but one silver lining (at least for me) was the
                            ability to work from home instead of commuting 2 hours a day to the office. With all this newly found
                            free time, I decided to do something useful and start programming. <br/><br/> I started with Java
                            since I already worked with enterprise applications and was familiar with the language from college.
                            This led me to learn Spring Framework, which I quickly realized I couldn't understand until I learned
                            the basics of web development. And out of this revelation can this very site. I decided to figure out
                            ...
                            concepts, or technologies I build make this a blog site so I had a space to describe anything I learned 
                            to cement it into my brain. If it happens to help someone else, then that is just the icing on the cake!
